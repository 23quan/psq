...
import com.example.psq.network.errorhandler.ExceptionHandler;
import com.example.psq.network.errorhandler.HttpErrorHandler;
import com.example.psq.network.interceptor.INetworkRequiredInfo;
import com.example.psq.network.interceptor.RequestInterceptor;
import com.example.psq.network.interceptor.ResponseInterceptor;
import com.example.psq.utils.SpData;
...
public class NetworkApi {
    ...
    public static String getBaseUrl() {
        String baseUrl = SpData.getBaseUrl();
        return baseUrl;
    }
