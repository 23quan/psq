package com.example.psq.view.timeselector.view;
...
import com.example.psq.view.timeselector.api.OnWheelScrollListener;
...
public class WheelView extends View {
    private static final int VALUE_TEXT_COLOR = R.color.black;
    private static final int ITEMS_TEXT_COLOR = R.color.color_939393;
    private static final int LABLE_TEXT_COLOR = R.color.color_2776FF;
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (!isScrollingPerformed && (valueLayout == null ||
                valueLayout.getWidth() > widthItems)) {
            String text = getAdapter() != null ? getAdapter().getItem(currentItem) : null;
            valueLayout = new StaticLayout(text != null ? text : "", valuePaint,
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, center - offset,
    ...
    private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2,
            ...
            int maxY = isCyclic ? 0x7FFFFFFF :
                    adapter.getItemsCount() * getItemHeight();
            int minY = isCyclic ? -maxY : 0;
            scroller.fling(0, lastScrollY, 0,
